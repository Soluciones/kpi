...
module Kpi
  ...
  CONFIGURACION = {
    ...
    'Contenidos en la semana (todos los tipos)' => [
      { texto: 'Contenidos publicados por usuarios Moderadores', modelo: CONTENIDO, scope: [:autor_admin, :ultima_semana] },
      { texto: 'Contenidos publicados por usuarios Expertos', modelo: CONTENIDO, scope: [:autor_experto, :ultima_semana] },
      { texto: 'Contenidos publicados por usuarios Normales', modelo: CONTENIDO, scope: [:autor_ni_admin_ni_experto, :ultima_semana] },
